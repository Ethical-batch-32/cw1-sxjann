                ...
                <div class="row gx-0 bg-secondary d-none d-lg-flex">
                    <div class="col-lg-7 px-5 text-start">
                        <div class="h-100 d-inline-flex align-items-center py-2 me-4">
                            ...
                            <h6 class="mb-0">kcsajan30@gmail.com</h6>
                        </div>
    ...
    <div class="container-fluid programe position-relative px-5 mt-5" style="margin-bottom: 135px;">
        <div class="row g-5 gb-5">
            ...
            <div class="col-lg-12 col-md-6 text-center">
                <h1 class="text-uppercase text-light mb-4">30% DISCOUNT, only to hot ones</h1>
                <a href="form.html" class="btn btn-primary py-3 px-5">Become A Member</a>
            </div>
        </div>
    </div>
    <!-- Programe Start -->
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                ...
                                <p class="text-uppercase text-secondary mb-0">Sajjan sir</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                ...
                                <p class="text-uppercase text-secondary mb-0">nasla ma'am</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                ...
                                <p class="text-uppercase text-secondary mb-0">Rekesh sir</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                ...
                                <p class="text-uppercase text-secondary mb-0">sandeepa ma'am</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                ...
                                <p class="text-uppercase text-secondary mb-0">Sudin sir</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">346</h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">16</h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">187</h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">863</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                ...
                                <span class="text-uppercase text-secondary">Sudina</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0">Syuchatar, Kathmandu, Nepal</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-envelope-open text-primary me-2"></i>
                            <p class="mb-0">kcsajan30@gmail.com</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-telephone text-primary me-2"></i>
                            <p class="mb-0">+977 9845358283</p>
                        </div>
                    </div>
